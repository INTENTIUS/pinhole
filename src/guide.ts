/**
 * The agent-facing guide. pinhole is a *tool*, not an agent: any agent (or human)
 * drives it through this CLI. This text is the single source of truth — `pinhole
 * guide` prints it, and AGENTS.md is generated from it (so the repo doc can't
 * drift; `inspect`/the test enforce the match).
 */
export const GUIDE = `# Driving pinhole (for agents)
